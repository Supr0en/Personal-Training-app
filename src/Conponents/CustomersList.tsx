...
import { deleteCustomer, getCustomers } from "../CustomerApi.ts";
import {
  useReactTable,
  getCoreRowModel,
  flexRender,
...
import { exportCsvFile } from "./helpers/ExportCsvFile.tsx";
...
export default function CustomersList() {
  ...
  return (
    <>
      ...
      <button className="px-4 py-2 bg-green-500 text-white rounded m-1" type="button" onClick={() => exportCsvFile(table)}>
      ...
      <table className="border ml-auto mr-auto mb-2 mt-2">
      ...
      <tbody className="bg-slate-200 overflow-auto">
